...
#' @param var_method Default value = FALSE. This means that equal on and off-axis 
#'   are expected. When the value is set to TRUE, unequal variances are assumed. The
#'   values of off-axis points are no longer generated by sigma but it is multiplied with 
#'   a factor specified in \code{inc_var}.
#' @param inc_var A numeric value that will increase the variance in off-axis points.
...
generateData <- function(pars, sigma, data = NULL, var_method = c("equal","unequal","model"), 
                         inc_var = NULL,
                         modelfit = NULL,
                         transforms = NULL,
