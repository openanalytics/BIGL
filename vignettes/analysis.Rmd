...
Presence of synergistic or antagonistic effects can be formalized by means of statistical tests. Two types of tests are considered here and are discussed in more details in the [methodology vignette](methodology.html) as well as the [accompanying paper](../papers/newStatistics.pdf).
